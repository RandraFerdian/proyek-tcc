...
class Order(Base):
    ...
    payment_method = Column(String(50), default="cash", nullable=True) # e.g., 'cash', 'transfer', 'qris'
    payment_status = Column(String(20), default="unpaid", nullable=True) # e.g., 'unpaid', 'paid'
