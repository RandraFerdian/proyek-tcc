...
const LandingPage = () => {
  return (
    ...
    <div className="h-full w-full overflow-y-auto bg-white scroll-smooth selection:bg-emerald-100 selection:text-emerald-900 font-sans antialiased text-slate-700">
      ...
      <nav className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-slate-100/80">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2.5 group cursor-pointer">
            <div className="w-10 h-10 bg-emerald-600 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-600/30 group-hover:rotate-[-10deg] transition-transform duration-300">
              <Package className="text-white" size={22} strokeWidth={2.5} />
            </div>
            <span className="text-2xl font-black text-slate-950 tracking-tighter">
              Catering Sehat<span className="text-emerald-600">.</span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/customer/login"
              className="px-5 py-2.5 text-sm font-bold text-slate-600 hover:text-emerald-600 rounded-xl hover:bg-emerald-50 transition-colors"
            >
              Lacak Pesanan
            </Link>
            <Link
      ...
      <section className="relative pt-24 pb-40 overflow-hidden z-10">
        <div className="max-w-7xl mx-auto px-6 text-center flex flex-col items-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-emerald-50 border border-emerald-100 text-emerald-700 text-xs font-bold uppercase tracking-widest mb-10 shadow-inner">
          ...
          <h1 className="text-6xl md:text-8xl font-black text-slate-950 tracking-tighter mb-8 leading-[0.95] max-w-4xl mx-auto">
            ...
            <span className="relative inline-block">
              <span className="relative z-10 text-emerald-600">Lebih Pintar</span>
              <span className="absolute bottom-3 left-0 w-full h-4 bg-emerald-100 z-0 rounded-full"></span>
            </span>
            & Tepat Waktu
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-24 w-full sm:w-auto">
            <Link
              to="/customer/login"
              className="w-full sm:w-auto px-10 py-4.5 bg-emerald-600 text-white text-lg font-bold rounded-2xl hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-600/30 flex items-center justify-center gap-2.5 group active:scale-95 hover:-translate-y-0.5"
            >
              Lacak Pesanan Saya
              <ArrowRight
          ...
          <div className="relative w-full max-w-5xl mx-auto mt-10 animate-fade-in-up">
            ...
            <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-[120%] h-[120%] bg-emerald-600/10 rounded-full blur-[120px] pointer-events-none"></div>
            ...
            <div className="relative bg-slate-950 p-3 rounded-[3rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] border-4 border-slate-800/50 aspect-[16/10] overflow-hidden group">
              ...
              <div className="w-full h-full bg-slate-100 rounded-[2.2rem] overflow-hidden relative border-2 border-slate-900">
                ...
                <div className="absolute inset-0 bg-[#f8f9fa]">
                  <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(22,163,74,0.08)_1px,transparent_1px),linear-gradient(rgba(22,163,74,0.08)_1px,transparent_1px)] bg-[size:56px_56px]" />
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_45%,rgba(132,204,22,0.18),transparent_35%),linear-gradient(135deg,#f7fee7,#f8fafc_45%,#ecfdf5)]" />
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 relative z-10">
                    ...
                    <div className="bg-emerald-600 p-3 rounded-2xl shadow-2xl border-2 border-white relative z-10">
                      <Package
                ...
                <div className="absolute bottom-5 left-5 right-5 bg-white/90 backdrop-blur-lg p-5 rounded-3xl shadow-xl border border-white flex items-center gap-4 transition-transform duration-500 group-hover:translate-y-[-10px]">
                  <div className="w-12 h-12 bg-emerald-50 rounded-full flex items-center justify-center font-black text-emerald-600 text-lg border-2 border-white shadow-inner">
                    R
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="bg-white p-9 rounded-[2.5rem] shadow-[0_15px_40px_-10px_rgba(0,0,0,0.03)] border border-slate-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.06)] group">
              <div className="w-16 h-16 bg-emerald-50 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-emerald-600 transition-colors duration-300 border border-emerald-100 shadow-inner group-hover:shadow-emerald-600/30">
                <MapPin
      ...
      <section className="bg-white py-32 relative z-10">
        <div className="max-w-7xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <p className="text-3xl md:text-4xl font-medium text-slate-950 max-w-3xl leading-snug tracking-tight mb-10">
            "Catering Sehat benar-benar mengubah cara kami mengelola
      ...
      <footer className="bg-slate-950 py-16 border-t border-slate-800 mt-auto relative z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 bg-emerald-600 rounded-lg flex items-center justify-center shadow-emerald-600/30">
              <Package className="text-white" size={18} strokeWidth={2.5} />
            </div>
            <span className="text-xl font-black text-white tracking-tighter">
              Catering Sehat<span className="text-emerald-500">.</span>
            </span>
          </div>
          <p className="text-sm font-medium text-slate-400">
            © {new Date().getFullYear()} Catering Sehat. Mengirim kehangatan,
            tepat waktu.
          </p>
        </div>
      </footer>
